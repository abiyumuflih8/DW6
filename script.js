const apiKey = '746273db88d64c6084133826241510';  // API key yang Anda dapatkan
const city = 'Greenland';
...
fetch(apiURL)
    ...
    .then(data => {
        ...
        data.forecast.forecastday.forEach((day) => {
            ...
            forecastHTML += `
                <div class="day">
                    <h4>${formattedDate}</h4>
                    <img class="weather-icon" src="${day.day.condition.icon}" alt="Ikon Cuaca">
    ...
    .catch(error => {
        ...
        document.getElementById('current-weather').innerHTML = '<p class="error-message">Terjadi kesalahan saat mengambil data cuaca.</p>';
        document.getElementById('weather-forecast').innerHTML = '<p class="error-message">Ramalan cuaca tidak dapat ditampilkan.</p>';
    });
